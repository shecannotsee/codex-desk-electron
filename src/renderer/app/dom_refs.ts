...
const el: UiElementRefs = {
  ...
  btnSidebarNewTeam: queryById<HTMLButtonElement>('btn-sidebar-new-team'),
  ...
  zoomFactorValue: queryById<HTMLInputElement>('zoom-factor-value'),
  btnZoomResetInline: queryById<HTMLButtonElement>('btn-zoom-reset-inline'),
  qsLanguageOptions: queryAll<HTMLButtonElement>('[data-language-option]'),
  ...
  qsSecurityEntryStatus: queryById<HTMLElement>('qs-security-entry-status'),
  ...
  qsSecurityStatusExplainer: queryById<HTMLElement>('qs-security-status-explainer'),
  qsSecurityUnlockCard: queryById<HTMLElement>('qs-security-unlock-card'),
  ...
  qsSecurityUnlockError: queryById<HTMLElement>('qs-security-unlock-error'),
  qsSecurityUnlockAction: queryById<HTMLButtonElement>('qs-security-unlock-action'),
  qsSecurityLockCard: queryById<HTMLElement>('qs-security-lock-card'),
  qsSecurityLockAction: queryById<HTMLButtonElement>('qs-security-lock-action'),
  qsSecurityPasswordLockedNote: queryById<HTMLElement>('qs-security-password-locked-note'),
  qsSecurityPasswordCard: queryById<HTMLElement>('qs-security-password-card'),
  ...
  qsSecurityPasswordError: queryById<HTMLElement>('qs-security-password-error'),
  ...
  createTeamModal: queryById<HTMLElement>('create-team-modal'),
  createTeamNameInput: queryById<HTMLInputElement>('create-team-name-input'),
  createTeamCancel: queryById<HTMLButtonElement>('create-team-cancel'),
  createTeamConfirm: queryById<HTMLButtonElement>('create-team-confirm'),
  addTeamRoleModal: queryById<HTMLElement>('add-team-role-modal'),
  addTeamRoleTitle: queryById<HTMLElement>('add-team-role-title'),
  addTeamRoleNameInput: queryById<HTMLInputElement>('add-team-role-name-input'),
  addTeamRoleProviderCodex: queryById<HTMLButtonElement>('add-team-role-provider-codex'),
  ...
  addTeamRoleConfirm: queryById<HTMLButtonElement>('add-team-role-confirm'),
  ...
  tabTeamAdd: queryById<HTMLElement>('tab-team-add'),
  tabTeamRoles: queryById<HTMLElement>('tab-team-roles'),
  tabTeamStatus: queryById<HTMLElement>('tab-team-status'),
  ...
  tabBtnTeamAdd: queryById<HTMLButtonElement>('tab-btn-team-add'),
  tabBtnTeamRoles: queryById<HTMLButtonElement>('tab-btn-team-roles'),
  tabBtnTeamStatus: queryById<HTMLButtonElement>('tab-btn-team-status'),
  ...
  btnAddTeamRole: queryById<HTMLButtonElement>('btn-add-team-role'),
