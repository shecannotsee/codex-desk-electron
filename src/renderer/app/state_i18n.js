...
const I18N = {
  'zh-CN': {
    ...
    importModeResumeDesc: '后续消息继续写进同一个 Codex 原生会话。如果原电脑也继续使用，会互相影响。',
  ...
  'en-US': {
    ...
    importModeResumeDesc: 'Future messages continue on the same native Codex session. If the original machine also keeps using it, both sides affect each other.',
