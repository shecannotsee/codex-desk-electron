...
const I18N: Record<string, Record<string, string>> = {
  'zh-CN': {
    ...
    securityEntryTitle: '凭据保护',
    securityEntryHint: '用主密码加密保存 Telegram Bot Token，锁定后需要解锁才能使用。',
    securityPaneTitle: '凭据保护',
    securityPaneHint: '主密码只用于保护本地保存的 Telegram Bot Token。设置后，相关凭据会以加密形式保存在当前设备。',
    securityStatusLabel: '当前状态',
    securityStatusUnset: '未设置主密码',
    securityStatusLocked: '已锁定',
    securityStatusUnlocked: '已解锁',
    securityUnlockPasswordLabel: '主密码',
    securityUnlockPasswordPlaceholder: '输入主密码后解锁凭据',
    securityUnlockAction: '解锁凭据',
    securityLockAction: '立即锁定',
    securityNewPasswordLabel: '新主密码',
    securityNewPasswordPlaceholder: '设置新的本地主密码',
    securityConfirmPasswordLabel: '确认主密码',
    securityConfirmPasswordPlaceholder: '再次输入主密码',
    securitySetPasswordAction: '设置主密码',
    securityChangePasswordAction: '修改主密码',
    securityLockedHint: '当前已锁定。解锁后才可查看、修改或测试已保存的 Telegram Bot Token。',
    securityUnlockedHint: '当前已解锁。你可以修改已保存的 Telegram Bot Token，也可以重新设置主密码。',
    securitySetPasswordHint: '设置主密码后，后续保存的 Telegram Bot Token 会改为加密保存。',
    securityPasswordEmpty: '请输入主密码',
    securityPasswordMismatch: '两次输入的主密码不一致',
    securitySetPasswordSuccess: '主密码已设置',
    securityChangePasswordSuccess: '主密码已更新',
    securityUnlockSuccess: 'Telegram 凭据已解锁',
    securityLockSuccess: 'Telegram 凭据已锁定',
  ...
  'en-US': {
    ...
    securityEntryTitle: 'Credential Vault',
    securityEntryHint: 'Encrypt saved Telegram Bot Tokens with a master password. Unlocking is required before use.',
    securityPaneTitle: 'Credential Vault',
    securityPaneHint: 'The master password protects only the Telegram Bot Tokens saved on this device. After setup, those credentials are stored locally in encrypted form.',
    securityStatusLabel: 'Status',
    securityStatusUnset: 'No master password',
    securityStatusLocked: 'Locked',
    securityStatusUnlocked: 'Unlocked',
    securityUnlockPasswordLabel: 'Master Password',
    securityUnlockPasswordPlaceholder: 'Enter the master password to unlock credentials',
    securityUnlockAction: 'Unlock Credentials',
    securityLockAction: 'Lock Now',
    securityNewPasswordLabel: 'New Master Password',
    securityNewPasswordPlaceholder: 'Set a new local master password',
    securityConfirmPasswordLabel: 'Confirm Master Password',
    securityConfirmPasswordPlaceholder: 'Enter the master password again',
    securitySetPasswordAction: 'Set Master Password',
    securityChangePasswordAction: 'Change Master Password',
    securityLockedHint: 'Credentials are locked. Unlock them before viewing, editing, or testing saved Telegram Bot Tokens.',
    securityUnlockedHint: 'Credentials are unlocked. You can edit saved Telegram Bot Tokens or replace the master password.',
    securitySetPasswordHint: 'After the master password is set, saved Telegram Bot Tokens will be stored in encrypted form.',
    securityPasswordEmpty: 'Enter the master password',
    securityPasswordMismatch: 'The two master password entries do not match',
    securitySetPasswordSuccess: 'Master password saved',
    securityChangePasswordSuccess: 'Master password updated',
    securityUnlockSuccess: 'Telegram credentials unlocked',
    securityLockSuccess: 'Telegram credentials locked',
    providerTelegram: 'Telegram',
    showSecret: 'Show',
    hideSecret: 'Hide',
