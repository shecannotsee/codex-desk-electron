...
const I18N: Record<string, Record<string, string>> = {
  'zh-CN': {
    ...
    telegramEnabled: '启用 Telegram 完成通知',
    telegramBotToken: 'Bot Token',
    telegramBotTokenPlaceholder: '填入 BotFather 生成的 Token',
    telegramChatId: 'Chat ID',
    telegramChatIdPlaceholder: '填入接收通知的 chat id',
    telegramHint: '通知会以对话 ID 为主标识，名称只用于快速识别。',
    saveSettings: '保存配置',
    testTelegramNotification: '发送测试通知',
    settingsSaved: '配置已保存',
  ...
  'en-US': {
    ...
    telegramEnabled: 'Enable Telegram completion notifications',
    telegramBotToken: 'Bot Token',
    telegramBotTokenPlaceholder: 'Paste the token from BotFather',
    telegramChatId: 'Chat ID',
    telegramChatIdPlaceholder: 'Paste the target chat id',
    telegramHint: 'Notifications use the conversation ID as the primary identifier. The name is only for quick scanning.',
    saveSettings: 'Save Settings',
    testTelegramNotification: 'Send Test Notification',
