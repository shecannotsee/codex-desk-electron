...
const I18N: Record<string, Record<string, string>> = {
  'zh-CN': {
    ...
    runtimeTipStatus: '这里会显示实时运行状态，开始一轮对话后就会持续刷新',
    runtimeTipWorkflow: '这里会显示运行步骤，等你新建会话后马上开工',
    runtimeTipRaw: '等待中：暂无会话',
    runtimeStatusCurrent: '当前状态',
    runtimeStatusPhase: '当前阶段',
    runtimeStatusElapsed: '已运行',
    runtimeStatusQueue: '排队消息',
    runtimeStatusCurrentStep: '当前关键步骤',
    runtimeStatusAssistant: 'Codex 中途输出',
    runtimeStatusRecent: '最近关键进展',
    runtimeStatusNone: '暂无',
    runtimeStatusNoAssistant: '当前还没有可展示的 Codex 输出',
    runtimeStatusNoProgress: '当前还没有关键进展',
  ...
  'en-US': {
    ...
    runtimeTipStatus: 'Live runtime status will appear here once a turn starts.',
    runtimeTipWorkflow: 'Workflow steps will appear here after you start.',
    runtimeTipRaw: 'Waiting: no active conversation',
    runtimeStatusCurrent: 'Current Status',
    runtimeStatusPhase: 'Current Phase',
    runtimeStatusElapsed: 'Elapsed',
    runtimeStatusQueue: 'Queued',
    runtimeStatusCurrentStep: 'Current Key Step',
    runtimeStatusAssistant: 'Codex Live Output',
    runtimeStatusRecent: 'Recent Progress',
    runtimeStatusNone: 'None',
    runtimeStatusNoAssistant: 'No Codex output available yet.',
    runtimeStatusNoProgress: 'No key progress yet.',
...
const el: UiElementRefs = {
  ...
  tabStatus: queryById<HTMLElement>('tab-status'),
  ...
  tabBtnStatus: queryById<HTMLButtonElement>('tab-btn-status'),
