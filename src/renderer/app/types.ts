...
export interface UiElementRefs {
  ...
  labelElapsed: HTMLElement;
  labelMetaVersion: HTMLElement;
  labelMetaModel: HTMLElement;
  labelMetaInput: HTMLElement;
  labelMetaCachedInput: HTMLElement;
  labelMetaOutput: HTMLElement;
  sessionId: HTMLElement;
  btnSessionId: HTMLButtonElement;
  btnMetaVersion: HTMLButtonElement;
  btnMetaModel: HTMLButtonElement;
  metaVersionValue: HTMLElement;
  metaModelValue: HTMLElement;
  usageMetaChip: HTMLElement;
  metaInputValue: HTMLElement;
  metaCachedInputValue: HTMLElement;
  metaOutputValue: HTMLElement;
  phase: HTMLElement;
