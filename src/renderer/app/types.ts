...
export interface UiElementRefs {
  ...
  qsSecurityEntryStatus: HTMLElement;
  ...
  qsSecurityStatusExplainer: HTMLElement;
  qsSecurityUnlockCard: HTMLElement;
  qsSecurityUnlockInput: HTMLInputElement;
  qsSecurityUnlockToggle: HTMLButtonElement;
  qsSecurityUnlockError: HTMLElement;
  qsSecurityUnlockAction: HTMLButtonElement;
  qsSecurityLockCard: HTMLElement;
  qsSecurityLockAction: HTMLButtonElement;
  qsSecurityPasswordLockedNote: HTMLElement;
  qsSecurityPasswordCard: HTMLElement;
  ...
  qsSecurityPasswordError: HTMLElement;
